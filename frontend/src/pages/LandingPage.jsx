...
const HeaderNav = () => (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-white/90 backdrop-blur-sm shadow-sm">
    ...
    return (
        <div className="min-h-screen flex flex-col pt-16">
            ...
            <header className="grow flex items-center justify-center bg-orange-50/50 py-15 px-4">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <h1 className="text-6xl md:text-7xl font-extrabold text-gray-900 leading-tight mb-6">
                        Understand Your Day, <span className="text-orange-600">Analyze Your Feelings.</span>
                    </h1>
            ...
            <section className="w-full max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">Tools for Deeper Reflection</h2>
